...
class OrdinaryDifferentialEquation PROTOBUF_FINAL :
 ...
 public:
  ...
  inline OrdinaryDifferentialEquation* New() const final {
    return CreateMaybeMessage<OrdinaryDifferentialEquation>(nullptr);
  }
...
inline ::ls::proto::ginac::lst* OrdinaryDifferentialEquation::_internal_mutable_functions() {
  ...
  if (functions_ == nullptr) {
    auto* p = CreateMaybeMessage<::ls::proto::ginac::lst>(GetArena());
    functions_ = p;
  }
  return functions_;
}
...
inline void OrdinaryDifferentialEquation::set_allocated_functions(::ls::proto::ginac::lst* functions) {
  ...
  if (functions) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(functions)->GetArena();
...
inline void OrdinaryDifferentialEquation::set_allocated_states(::ls::proto::ginac::lst* states) {
  ...
  if (states) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(states)->GetArena();
    if (message_arena != submessage_arena) {
...
inline ::ls::proto::ginac::symbol* OrdinaryDifferentialEquation::_internal_mutable_time() {
  _has_bits_[0] |= 0x00000008u;
  if (time_ == nullptr) {
    auto* p = CreateMaybeMessage<::ls::proto::ginac::symbol>(GetArena());
    time_ = p;
  }
  return time_;
}
