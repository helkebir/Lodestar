...
inline ::ls::proto::eigen::MatrixXd* StateSpace::_internal_mutable_a() {
  _has_bits_[0] |= 0x00000001u;
  if (a_ == nullptr) {
    auto* p = CreateMaybeMessage<::ls::proto::eigen::MatrixXd>(GetArenaForAllocation());
    a_ = p;
  }
  return a_;
}
...
inline ::ls::proto::eigen::VectorXd* TransferFunction::_internal_mutable_num() {
  _has_bits_[0] |= 0x00000001u;
  if (num_ == nullptr) {
    auto* p = CreateMaybeMessage<::ls::proto::eigen::VectorXd>(GetArenaForAllocation());
    num_ = p;
  }
  return num_;
}
...
inline void TransferFunction::set_allocated_num(::ls::proto::eigen::VectorXd* num) {
  ...
  if (num) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(num));
    if (message_arena != submessage_arena) {
...
inline void TransferFunction::set_allocated_den(::ls::proto::eigen::VectorXd* den) {
  ...
  if (den) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(den));
    if (message_arena != submessage_arena) {
