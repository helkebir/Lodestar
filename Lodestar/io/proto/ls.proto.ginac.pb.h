...
class ex final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_archive();
  void set_allocated_archive(std::string* archive);
  private:
  const std::string& _internal_archive() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_archive(const std::string& value);
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ex::set_archive(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 archive_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ex::_internal_set_archive(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  archive_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ex::_internal_mutable_archive() {
  _has_bits_[0] |= 0x00000001u;
  return archive_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ex::release_archive() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return archive_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
