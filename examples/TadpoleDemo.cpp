...
/**
 * @brief Tadpole car code generation and LQR control demo.
 * @ingroup examples_module
 *
 * @details Illustrates use of ls::symbolic::OrdinaryDifferentialEquation, ls::systems::StateSpace<>,
 * ls::analysis::ZeroOrderHold, ls::analysis::BilinearTransformation, and ls::control::DiscreteLQR.
*/
void tadpoleDemo()
{
    { // ODE Codegen Demo
